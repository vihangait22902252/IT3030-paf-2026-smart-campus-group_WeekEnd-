...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, OAuth2LoginSuccessHandler oAuth2LoginSuccessHandler) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/resources/**", "/api/bookings/**", "/api/system/**", "/api/admin/**", "/api/notifications/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        cors.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://127.0.0.1:5173"));
